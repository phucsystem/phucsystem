# Hi, I'm Phuc (Phil) Dang

**Tech Lead & Senior Software Engineer** based in Vietnam
...
- Building experimental tools at PhucsystemLabs
...
| Project | Description |
|---------|-------------|
| [PhucsystemLabs](https://github.com/phucsystem/phucsystemlabs-home-page) | Product lab for experimental tools and web apps |
| [Mobile Device Frames](https://github.com/phucsystem/mobile-device-frames) | Realistic device frames for HTML prototypes |
| [DevOps CLI](https://github.com/phucsystem/devops_cli) | CLI toolkit for common DevOps operations |
| [Kid Safe Chatty](https://github.com/phucsystem/kid-safe-chatty) | AI-powered kid-safe chat app built with C# and .NET |
